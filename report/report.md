...
## Dashboard
Built "Data Exfiltration Detection Dashboard" as a Classic Dashboard with two panels: total bytes/MB transferred per user (bar chart, shows the stark svc_account spike) and a time-series panel showing bytes_sent activity across the attack window.
